...
removeValue(std::shared_ptr<BinaryNode<ItemType>> subTreePtr,
   ...
   // binary search tree.
   std::shared_ptr<BinaryNode<ItemType>> 
removeNode(std::shared_ptr<BinaryNode<ItemType>> nodePtr);
   ...
   std::shared_ptr<BinaryNode<ItemType>> 
removeLeftmostNode(std::shared_ptr<BinaryNode<ItemType>> subTreePtr,
...
override;
   ...
   //------------------------------------------------------------
   // Replacment Algorithm
   //------------------------------------------------------------
   bool replace(const ItemType& item, const ItemType& itemReplace) const;

//   BinarySearchTreeIterator<ItemType> start();
//   BinarySearchTreeIterator<ItemType> end();
};
